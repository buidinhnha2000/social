      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="fullname"
            name="fullname" onChange={handleChangeInput} value={fullname}
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="username"
            name="username" onChange={handleChangeInput} value={username.toLowerCase().replace(/ /g, '')}
        ...
        <div className="mb-3">
          ...
          <div className="pass">
            <input type={typeConfirmPass ? "text" : "password"} className="form-control"
        ...
        <p className="my-2">
          You already have an account? <Link to="/" style={{ color: "crimson" }}>Login Now</Link>
